...
> [Get a Gateway account →](https://ansvar.eu/gateway)
>
> One OAuth signup gives Claude Desktop, Cursor, or Copilot grounded access
> to this MCP through `gateway.ansvar.eu`. No corpus download, no ingestion.
> Free tier covers most evaluation and personal use.
